...
.signin-active a {
  ...
  border-bottom: solid 2px #4E43B7;
...
<div class="container2">
  <div class="frame">
    ...
    <div ng-app ng-init="checked = false">
                ...
                <input class="form-styling" type="text" name="pseudo_utilisateur mail_utilisateur" placeholder="Pseudo"/>
          
                <label for="pw_utilisateur">Mot de passe</label>
          
                <input class="form-styling" type="text" name="pw_utilisateur" placeholder="Mot de passe"/>
                ...
                <a class="btn-signin">Connexion</a>
				        ...
				        <form class="form-signup" action="php/traitement-connexion.php" method="POST" name="form" >
                ...
                <a href="php/traitement-connexion.php" class="btn-signup">Inscription</a>
				        </form>
       ...
       viewBox="0 0 60 60" id="check" ng-class="checked ? 'checked' : ''">
                ...
                <div class="successtext">
                   <p> Merci de vous être inscrit! verifiez votre boîte mail pour confirmer votre adresse</p>
                </div>
             </div>
      </div>
     ...
     <!-- <div>
        ...
        <h1 class="welcome">Bienvenue, <?php //echo$_POST['pseudo_utilisateur'];?></h1> 
        <a class="btn-goback" value="Refresh" onClick="history.go()">Retour</a>
      </div>-->
  </div>
