    ...
    <div class="frame">
      ...
      <div ng-app ng-init="checked = false">
        <form class="form-signin" action="" method="post" name="form">
          ...
          <input class="form-styling" type="text" name="password" placeholder="Mot de passe" />
        ...
        <form class="form-signup" action="" method="post" name="form">
          ...
          <input class="form-styling" type="text" name="fullname" placeholder="Pseudo" />
          <label for="email">Email</label>
          <input class="form-styling" type="text" name="email" placeholder="Email" />
          <label for="password">Mot de passe</label>
          <input class="form-styling" type="text" name="password" placeholder="Mot de passe" />
          <label for="confirmpassword">Confirmer le mot de passe</label>
          <input class="form-styling" type="text" name="confirmpassword" placeholder="Confirmer le mot de passe" />
          <a ng-click="checked = !checked" class="btn-signup">Inscription</a>
        </form>
      ...
      <div>
        ...
        <h1 class="welcome">Bienvenue, XXX</h1>
