...
<?php include('navnl.php') ?>
  ...
  <div class="flex-row">
    ...
    <input name="mail_utilisateur" id="username" class='lf--input' placeholder='Email' type='text'required>
  </div>
  <div class="flex-row">
  ...
  <div class="flex-row">
    ...
    <input name="confirmpassword" id="password" class='lf--input' placeholder='Confirmez le Mot de passe' type='password'required>
  </div>
