...
<?php include('navnl.php') ?>
  ...
  <div class="flex-row">
    ...
    <input name="pseudo_utilisateur" id="username" class='lf--input' placeholder='Pseudo' type='text'>
  </div>
  <div class="flex-row">
    <label class="lf--label" for="username">
      <svg x="0px" y="0px" width="12px" height="13px">
    ...
    <input name="mail_utilisateur" id="username" class='lf--input' placeholder='Email' type='text'>
  </div>
  <div class="flex-row">
    ...
    <input name="pw_utilisateur" id="password" class='lf--input' placeholder='Mot de passe' type='password'>
  </div>
  <div class="flex-row">
    <label class="lf--label" for="password">
      <svg x="0px" y="0px" width="15px" height="5px">
    ...
    <input name="confirmpassword" id="password" class='lf--input' placeholder='Confirmez le Mot de passe' type='password'>
  </div>
  <input class='lf--submit' type='submit' value='Inscription'>
</form>
