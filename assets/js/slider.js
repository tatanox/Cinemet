...
//           numero = 0;
//       document.getElementById("slide0").src = slide[numero];
//   }
//   var slide0 = new Array("slider0",);
//   var numero = 0
//   function ChangeSlide(sens) {
//       numero = numero + sens;
//       if (numero < 0)
...
//          if (numero > slide.length - 1)
//              numero = 0;
//          document.getElementById("slide3").src = slide[numero];
//         }
  
//         var slide0 = new Array("slider4",);
//   var numero = 4
//   function ChangeSlide(sens) {
//       numero = numero + sens;
//       if (numero < 0)
...
//       if (numero > slide.length - 1)
//           numero = 0;
//       document.getElementById("slide4").src = slide[numero];
//      }
     
//      var slide1 = new Array("slider5",);
//      var numero = 5
//      function ChangeSlide(sens) {
//          numero = numero + sens;
//          if (numero < 0)
...
//          if (numero > slide.length - 1)
//              numero = 0;
//          document.getElementById("slide5").src = slide[numero];
//         }
        
//         var slide0 = new Array("slider6",);
//   var numero = 0
//   function ChangeSlide(sens) {
//       numero = numero + sens;
//       if (numero < 0)
...
//       if (numero > slide.length - 1)
//           numero = 0;
//       document.getElementById("slide6").src = slide[numero];
//      } 
     
//      var slide1 = new Array("slider7",);
//      var numero = 0
//      function ChangeSlide(sens) {
//          numero = numero + sens;
//          if (numero < 0)
...
//          if (numero > slide.length - 1)
//              numero = 0;
//          document.getElementById("slide7").src = slide[numero];
//         }
